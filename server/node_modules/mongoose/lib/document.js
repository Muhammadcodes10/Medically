...
const DivergentArrayError = require('mongoose/types/lib/error/divergentArray');
const EventEmitter = require('events').EventEmitter;
const InternalCache = require('mongoose/types/lib/internal');
const MongooseBuffer = require('mongoose/types/lib/types/buffer');
const MongooseError = require('mongoose/types/lib/error');
const MixedSchema = require('mongoose/types/lib/schema/mixed');
const ModifiedPathsSnapshot = require('mongoose/types/lib/modifiedPathsSnapshot');
const ObjectExpectedError = require('mongoose/types/lib/error/objectExpected');
const ObjectParameterError = require('mongoose/types/lib/error/objectParameter');
const ParallelValidateError = require('mongoose/types/lib/error/parallelValidate');
const Schema = require('mongoose/types/lib/schema');
const StrictModeError = require('mongoose/types/lib/error/strict');
const ValidationError = require('mongoose/types/lib/error/validation');
const ValidatorError = require('mongoose/types/lib/error/validator');
const $__hasIncludedChildren = require('mongoose/types/lib/helpers/projection/hasIncludedChildren');
const applyDefaults = require('mongoose/types/lib/helpers/document/applyDefaults');
const cleanModifiedSubpaths = require('mongoose/types/lib/helpers/document/cleanModifiedSubpaths');
const clone = require('mongoose/types/lib/helpers/clone');
const compile = require('mongoose/types/lib/helpers/document/compile').compile;
const defineKey = require('mongoose/types/lib/helpers/document/compile').defineKey;
const firstKey = require('mongoose/types/lib/helpers/firstKey');
const flatten = require('mongoose/types/lib/helpers/common').flatten;
const getEmbeddedDiscriminatorPath = require('mongoose/types/lib/helpers/document/getEmbeddedDiscriminatorPath');
const getKeysInSchemaOrder = require('mongoose/types/lib/helpers/schema/getKeysInSchemaOrder');
const getSubdocumentStrictValue = require('mongoose/types/lib/helpers/schema/getSubdocumentStrictValue');
const handleSpreadDoc = require('mongoose/types/lib/helpers/document/handleSpreadDoc');
const isBsonType = require('mongoose/types/lib/helpers/isBsonType');
const isDefiningProjection = require('mongoose/types/lib/helpers/projection/isDefiningProjection');
const isExclusive = require('mongoose/types/lib/helpers/projection/isExclusive');
const isPathExcluded = require('mongoose/types/lib/helpers/projection/isPathExcluded');
const inspect = require('util').inspect;
const internalToObjectOptions = require('mongoose/types/lib/options').internalToObjectOptions;
const markArraySubdocsPopulated = require('mongoose/types/lib/helpers/populate/markArraySubdocsPopulated');
const minimize = require('mongoose/types/lib/helpers/minimize');
const mpath = require('mpath');
const parentPaths = require('mongoose/types/lib/helpers/path/parentPaths');
const queryhelpers = require('mongoose/types/lib/queryHelpers');
const utils = require('mongoose/types/lib/utils');
const isPromise = require('mongoose/types/lib/helpers/isPromise');

const deepEqual = utils.deepEqual;
const isMongooseObject = utils.isMongooseObject;

const arrayAtomicsBackupSymbol = require('mongoose/types/lib/helpers/symbols').arrayAtomicsBackupSymbol;
const arrayAtomicsSymbol = require('mongoose/types/lib/helpers/symbols').arrayAtomicsSymbol;
const documentArrayParent = require('mongoose/types/lib/helpers/symbols').documentArrayParent;
const documentIsModified = require('mongoose/types/lib/helpers/symbols').documentIsModified;
const documentModifiedPaths = require('mongoose/types/lib/helpers/symbols').documentModifiedPaths;
const documentSchemaSymbol = require('mongoose/types/lib/helpers/symbols').documentSchemaSymbol;
const getSymbol = require('mongoose/types/lib/helpers/symbols').getSymbol;
const modelSymbol = require('mongoose/types/lib/helpers/symbols').modelSymbol;
const populateModelSymbol = require('mongoose/types/lib/helpers/symbols').populateModelSymbol;
const scopeSymbol = require('mongoose/types/lib/helpers/symbols').scopeSymbol;
const schemaMixedSymbol = require('mongoose/types/lib/schema/symbols').schemaMixedSymbol;
const getDeepestSubdocumentForPath = require('mongoose/types/lib/helpers/document/getDeepestSubdocumentForPath');
const sessionNewDocuments = require('mongoose/types/lib/helpers/symbols').sessionNewDocuments;
...
Document.prototype.$__set = function(pathToMark, path, options, constructing, parts, schema, val, priorVal) {
  Embedded = Embedded || require('mongoose/types/lib/types/arraySubdocument');
  ...
  if (shouldModify) {
    ...
    MongooseArray || (MongooseArray = require('mongoose/types/lib/types/array'));
...
Document.prototype.$__getArrayPathsToValidate = function() {
  DocumentArray || (DocumentArray = require('mongoose/types/lib/types/documentArray'));
