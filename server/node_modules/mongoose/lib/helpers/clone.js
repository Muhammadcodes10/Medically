...
const Decimal = require('mongoose/types/lib/types/decimal128');
...
const isMongooseArray = require('mongoose/types/lib/types/array/isMongooseArray').isMongooseArray;
const isObject = require('mongoose/types/lib/helpers/isObject');
const isPOJO = require('mongoose/types/lib/helpers/isPOJO');
const symbols = require('mongoose/types/lib/helpers/symbols');
const trustedSymbol = require('mongoose/types/lib/helpers/query/trusted').trustedSymbol;
