...
const ObjectId = require('mongoose/types/lib/types/objectid');
const PopulateOptions = require('mongoose/types/lib/options/populateOptions');
const clone = require('mongoose/types/lib/helpers/clone');
const immediate = require('mongoose/types/lib/helpers/immediate');
const isObject = require('mongoose/types/lib/helpers/isObject');
const isMongooseArray = require('mongoose/types/lib/types/array/isMongooseArray');
const isMongooseDocumentArray = require('mongoose/types/lib/types/documentArray/isMongooseDocumentArray');
const isBsonType = require('mongoose/types/lib/helpers/isBsonType');
const isPOJO = require('mongoose/types/lib/helpers/isPOJO');
const getFunctionName = require('mongoose/types/lib/helpers/getFunctionName');
const isMongooseObject = require('mongoose/types/lib/helpers/isMongooseObject');
const schemaMerge = require('mongoose/types/lib/helpers/schema/merge');
const specialProperties = require('mongoose/types/lib/helpers/specialProperties');
const { trustedSymbol } = require('mongoose/types/lib/helpers/query/trusted');
...
exports.toObject = function toObject(obj) {
  Document || (Document = require('mongoose/types/lib/document'));
  let ret;
...
exports.isPOJO = require('mongoose/types/lib/helpers/isPOJO');
